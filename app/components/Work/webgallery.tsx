...
const images = [project3, project4];
const titles = ['full stack', 'mobile developer']
const descriptions = ['mobile designer', 'web designer']
// const infos = {
//    name: 'full stack', descriptions:'mobile developer'
//    name: 'Jmobile designer', descriptions:'web designer'
